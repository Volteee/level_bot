...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('INITIATOR', 'INSPECTOR', 'ADMIN', 'UNKNOWN', name='userroleenum'), nullable=False),
    ...
    sa.Column('state', sa.Enum('CREATED', 'PENDING', 'SUCCESS', 'CANCELED', name='orderstateenum'), nullable=False),
